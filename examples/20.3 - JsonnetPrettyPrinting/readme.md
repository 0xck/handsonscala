# Example 20.3 - JsonnetPrettyPrinting
...
## Upstream Example: [20.2 - JsonnetNumbers](https://github.com/handsonscala/handsonscala/tree/master/examples/20.2%20-%20JsonnetNumbers):
Diff:
```diff
