...
Diff:
```diff
diff --git a/20.1 - Jsonnet/Jsonnet.sc b/20.2 - JsonnetNumbers/Jsonnet.sc
index 4ebe482..a66a3a0 100644
--- a/20.1 - Jsonnet/Jsonnet.sc	
+++ b/20.2 - JsonnetNumbers/Jsonnet.sc	
@@ -1,6 +1,7 @@
 sealed trait Expr
 object Expr{
...
diff --git a/20.1 - Jsonnet/TestJsonnet.sc b/20.2 - JsonnetNumbers/TestJsonnet.sc
index 8cce963..4b5e005 100644
--- a/20.1 - Jsonnet/TestJsonnet.sc	
+++ b/20.2 - JsonnetNumbers/TestJsonnet.sc	
...
- [20.3 - JsonnetPrettyPrinting](https://github.com/handsonscala/handsonscala/tree/master/examples/20.3%20-%20JsonnetPrettyPrinting)